...
- [2. 規制環境とコンプライアンス要件（2026年の日本市場）](#2-規制環境とコンプライアンス要件2026年の日本市場)
- [3. システムアーキテクチャ概要](#3-システムアーキテクチャ概要)
- [4. コンポーネント詳細解説：ERC-4337/EIP-7702 と Passkey](#4-コンポーネント詳細解説erc-4337eip-7702-と-passkey)
- [5. コンポーネント詳細解説：分散型ID (DID) と Verifiable Credentials (VC)](#5-コンポーネント詳細解説分散型id-did-と-verifiable-credentials-vc)
- [6. コンポーネント詳細解説：チケットSBT (ERC-5192)](#6-コンポーネント詳細解説チケットsbt-erc-5192)
- [7. コンポーネント詳細解説：プライバシーと入場認証 (ZKP)](#7-コンポーネント詳細解説プライバシーと入場認証-zkp)
- [8. 実装ロードマップと統合戦略](#8-実装ロードマップと統合戦略)
- [9. 結論](#9-結論)
- [10. 技術選定の更新に関する補足 (2026年版)](#10-技術選定の更新に関する補足-2026年版)
