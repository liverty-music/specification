...
Provides the console's persistent navigation frame around every admin screen, giving the operator a way back and their organizational context from anywhere, so no screen is reachable only by entering its address directly.
