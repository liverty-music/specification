<!-- spec: concert-highway-ce | target: components/infrastructure/fan/web/global/live-highway | flags: CLASSNAME | new_name: Beam tracking updates efficiently per frame -->
