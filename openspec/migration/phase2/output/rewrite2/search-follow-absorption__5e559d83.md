<!-- spec: search-follow-absorption | target: components/infrastructure/fan/web/route/discovery | flags: CLASSNAME | new_name: Search result follow triggers bubble view transition and absorption animation -->
