<!-- spec: frontend-entity-layer | target: components/infrastructure/fan/web/locale/venue-admin-area-label | flags: CLASSNAME | new_name: Concert admin-area shown as localized label -->
