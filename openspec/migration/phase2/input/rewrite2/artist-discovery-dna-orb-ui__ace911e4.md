<!-- spec: artist-discovery-dna-orb-ui | target: components/infrastructure/fan/web/global/dna-orb | flags: CLASSNAME | new_name: Orb Activation Separates Gesture Celebration From Follow-Count State -->
<!-- implementation names to remove: getStageParams -->
