<!-- merge_group: LANG-RESOLUTION | target: components/infrastructure/fan/web/locale/language-resolution | members: 2 -->

<!-- member: user-language-preference | flags: CLASSNAME -->
