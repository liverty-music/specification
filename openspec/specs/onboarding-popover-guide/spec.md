# Onboarding Popover Guide

## Purpose

Provides a one-time instructional popover when onboarding users first visit the discover page, using the native Popover API with light-dismiss behavior. Replaces the previous persistent HUD approach.
