# Capability: unified-check-interface

## Purpose

Defines a standard Makefile interface (`lint`, `fix`, `test`, `test-integration`, `check`) across all repos, enabling consistent developer and CI workflows. CI workflows call these targets instead of inline tool commands.
