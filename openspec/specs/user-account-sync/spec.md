...
The `user-account-sync` capability handles provisioning local user records when users register via Zitadel, linking external identities to the application database using the `external_id` field.
