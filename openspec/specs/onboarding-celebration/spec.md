...
Provides an emotional payoff when the user first arrives at the Dashboard during onboarding, displaying a full-screen celebration overlay with confetti animation after completing artist discovery.
