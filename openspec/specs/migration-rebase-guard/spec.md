# migration-rebase-guard Specification

## Purpose

Detect and auto-fix out-of-order database migration timestamps that arise from concurrent branch development, ensuring migration files maintain correct chronological ordering relative to the main branch.
